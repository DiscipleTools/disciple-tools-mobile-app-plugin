...
function dt_mobile_app() {
    ...
    if ( 'Disciple Tools' == $current_theme || dt_is_child_theme_of_disciple_tools() ) {
        ...
        add_action( 'wp_ajax_dismissed_notice_handler', 'dt_mobile_app_ajax_notice_handler' );
 ...
 */
function dt_mobile_app_no_disciple_tools_theme_found()
{
    ?>
    <div class="notice notice-error">
        <p><?php esc_html_e( "'Disciple Tools - DT Mobile App' requires 'Disciple Tools' theme to work. Please activate 'Disciple Tools' theme or deactivate 'Disciple Tools - DT Mobile App' plugin.", "dt_mobile_app" ); ?></p>
    </div>
    <?php
}
...
function dt_mobile_app_hook_admin_notice() {
    ...
    if ( ! get_option( 'dismissed-dt-starter', false ) ) {
        ...
        <div class="notice notice-error notice-dt-starter is-dismissible" data-notice="dt-demo">
            <p><?php esc_html_e( "'Disciple Tools - DT Mobile App' requires 'Disciple Tools' theme to work. Please activate 'Disciple Tools' theme or deactivate 'Disciple Tools - DT Mobile App'." ); ?></p>
        </div>
        <script>
            jQuery(function($) {
 ...
 */
function dt_mobile_app_ajax_notice_handler() {
    $type = 'dt-starter';
